    ...
    },
    {
      ...
      child: [
        ...
        },
        {
          ...
          docdetail: { item: 'Academic Transcript', id: data.name },
        },
        {
          ...
          docdetail: { item: 'Academic Certificate', id: data.name },
        },
      ],
    },
    {
  ...
  useEffect(() => {
    if (data && data.qualifications && data.qualifications.length) {
      ...
      setValue('english_language_qualification', {
        label: qdata.english_language_qualification,
        value: qdata.english_language_qualification,
      });
      setValue('score', 23);
      ...
      if (port) {
        setValue('portfolio', {
          fileList: [
            {
              uid: '-1',
              name: getFileName(port.document),
              status: 'done',
              url: port.document,
              s3: 'Portfolio',
              aid: data?.applicant_id,
    ...
    if (data && data?.students_programs && data?.students_programs.length) {
      let qdata = selectProg
        ? data?.students_programs.find((x) => x.program.program == selectProg)
        : data?.students_programs.find((x) => x.program.program_status == 'Active');
