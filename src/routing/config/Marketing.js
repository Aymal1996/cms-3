...
export const Marketing = [
  ...
  {
    component: 'LeadApplications',
    path: '/marketing/applications/lead-applications',
    title: titles.MARKETING,
    permission: [AllRoles.MARKETING.APPLICATION],
    menu: 'Marketing',
    key: 'marketing',
  ...
  {
    component: 'EditApplication',
    path: '/marketing/applications/lead-applications/:id',
    title: titles.MARKETING,
    permission: [AllRoles.MARKETING.APPLICATION],
    menu: 'Marketing',
    key: 'marketing',
  ...
  {
    component: 'Students',
    path: '/marketing/applications/approved',
    title: titles.MARKETING,
    permission: [AllRoles.MARKETING.STUDENTS],
    menu: 'Marketing',
    key: 'marketing',
  ...
  },
  {
    ...
    title: titles.MARKETING,
    permission: [AllRoles.MARKETING.AGENTS],
    menu: 'Marketing',
    key: 'marketing',
    submenu: 'Agents',
    icon: 'UserIcon',
